...
The workbook contains create_backups workflow to create backups.
...
The workflow accepts the following input parameters:
  ...
  - volume_id_list - list of volume identifiers.
    ...
    Optional.
  - is_incremental - create an imcremental backup or full.
    Default is false.
    Optional.
...
create_backups workflow tasks:
  ...
  - analyze_input
    ...
    - choses the task to execute next accordingly to input

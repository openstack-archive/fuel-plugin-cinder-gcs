...
* GCS Bucket Location
  ...
  * type: dropdown list
  * initial value: 'us'
  * list values: locations listed on
    https://cloud.google.com/storage/docs/bucket-locations
...
* GCS Object Size
  ...
  * type: text
  * initial value: 52428800
  * regexp: is a number in a range from 1 to 9223372036854775807
...
* HTTP User-Agent
  ...
  * regexp: a valid string accordigly to HTTP 1.1 RFC
...
* GCS Reader Chunk Size
  ...
  * regexp: a number in a range from 1 to 9223372036854775807 OR -1
  * visibility: only when backup_gcs_advanced_settings is selected
...
* GCS Writer Chunk Size
  ...
  * type: text
  * initial value: 2097152
  * regexp: a number in a range from 1 to 5242880 OR -1
  * visibility: only when backup_gcs_advanced_settings is selected
...
* GCS Retry Error Codes
  ...
  * type: text
  * initial value: [‘429’]
  * regexp: valid list of HTTP v1.1 error codes (4xx and 5xx)
  * visibility: only when backup_gcs_advanced_settings is selected

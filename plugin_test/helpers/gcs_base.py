...
class GcsTestBase(TestBasic):
    ...
    def get_test_list():
        """
        Method designed to collect tempest test list which will be executed as
    ...
    def exec_with_verification(remote, cmd, ex_code_expected=0):
        """
        Method designed to execute some command on the remote host, and verify
        its exit code, it should be 0.
        """
    ...
    def get_container_id(remote):
        """
        Method designed to obtain docker container id with tempest installed in
        that container.
        """
    ...
    def upload_creds(remote):
        """
        Method designed to upload credentials.json file required for plugin
        installation to fuel master node.
        """
    ...
    def _verify_services_on_node(self, active_node, devops_node,
        ...
        """
        Method designed to verify if services became active on a specific node.
        """
    ...
    def cicd_ha_destroy_node_by_role(self, cluster_id, node_role_list):
        """
        Method designed to disable nodes by roles. Accepts a list of roles list
        and can accept more than one role, example:
    ...
    def resume_node(self, nodes_to_re_enable, cluster_id):
        """
        Method designed to enable nodes, accepts disabled nodes list as a
        argument - nodes_to_re_enable.
        """

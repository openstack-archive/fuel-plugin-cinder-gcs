...
class GcsTestBase(TestBasic):
    ...
    @staticmethod
    def get_test_list():
        """Method designed to collect tempest test list which will be executed
         as acceptance testing stage.
        """
    ...
    def exec_with_verification(remote, cmd, ex_code_expected=0):
        """Method designed to execute some command on the remote host, and
        verify its exit code, it should be 0.
        """
    ...
    def _verify_services_on_node(self, active_node, devops_node,
        ...
        """Method designed to verify if services became active on a specific
        node.
        """
    ...
    def cicd_ha_destroy_node_by_role(self, cluster_id, node_role_list):
        """Method designed to disable nodes by roles. Accepts a list of roles
        list and can accept more than one role, example:
